...
export default function LaporanBarangMasuk({ barangMasukData, lokasiList, filters }: LaporanBarangMasukProps) {
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Barang Masuk', href: '/laporan/masuk' },
            ]}
        >
            ...
            <div className="report-page px-4 py-6 md:px-6 lg:px-8">
                <div className="w-full">
                    ...
                    <h1 className="mt-1 mb-6 text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">Barang Masuk</h1>
