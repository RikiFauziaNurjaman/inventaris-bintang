                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {item.keluar_info.length > 1 && (
                                    <button
                                        type="button"
                                        className="rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-600 hover:bg-red-100 md:hidden dark:bg-red-900/20 dark:text-red-400"
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {item.keluar_info.length > 1 && (
                                    <button
                                        type="button"
                                        className="hidden rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-600 hover:bg-red-100 md:block dark:bg-red-900/20 dark:text-red-400"
                                        onClick={() => removeSerialField(infoIndex)}
                                    >
                                        Hapus
                                    </button>
...
export default function BarangKeluarCreate() {
    ...
    return (
        <TransactionFormPage
            ...
            description="Catat distribusi, peminjaman, atau penjualan barang ke lokasi tujuan."
